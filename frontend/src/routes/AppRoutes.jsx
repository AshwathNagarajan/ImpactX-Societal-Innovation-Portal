...
export default function AppRoutes() {
  return <Routes>
    ...
    <Route path="/industry" element={<RequireRole role="industry"><DashboardLayout title="Industry Partner" items={industryItems}/></RequireRole>}>
      <Route index element={<IndustryDashboard/>}/><Route path="discover" element={<DiscoverProjects/>}/><Route path="recommended" element={<DiscoverProjects recommendedOnly/>}/><Route path="partnerships" element={<Partnerships/>}/><Route path="mentorship" element={<Mentorship/>}/><Route path="funding" element={<Funding/>}/><Route path="pilots" element={<Pilots/>}/><Route path="impact" element={<AdminAnalytics/>}/><Route path="notifications" element={<Utility title="Industry Notifications"/>}/><Route path="profile" element={<ProfilePage type="industry"/>}/>
    </Route>
