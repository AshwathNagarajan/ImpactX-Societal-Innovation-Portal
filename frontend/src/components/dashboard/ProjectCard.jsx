...
export default function ProjectCard({ project, action }) {
  const stage = project.current_stage?.label || getLifecycleLabel(project);
  const progress = getLifecycleProgress(project);
