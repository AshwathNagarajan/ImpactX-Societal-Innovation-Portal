...
export default function SubmitChallenge() {
  ...
  const [otp, setOtp] = useState({ verification_id: "", code: "", verified: false, message: "", dev_otp: "" });
  ...
  const requestOtp = async () => {
    ...
    try {
      ...
      setOtp({ verification_id: response.verification_id || response.data?.verification_id || "", code: "", verified: false, message: response.message || "OTP sent.", dev_otp: response.dev_otp || response.data?.dev_otp || "" });
    } catch (err) {
