...
export default function ChallengeDetails() {
  ...
  return <div className="mx-auto max-w-[1440px] px-4 py-10 sm:px-6 md:py-12 lg:px-10 xl:px-12">
    ...
    <div className="mt-8 grid gap-8 lg:grid-cols-[.9fr_1.1fr]">
      <section className="rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-violet-50 p-6 shadow-sm md:p-8"><h2 className="text-xl font-semibold text-navy md:text-2xl">AI Analysis</h2><div className="mt-6 space-y-4 text-sm"><Info k="Suggested category" v={c.category}/><Info k="Priority score" v={`${c.priority==="Critical"?94:c.priority==="High"?86:68}/100`}/><Info k="Duplicate probability" v="12% low-risk match"/><Info k="Recommended institute domains" v="AI, IoT, field research, public systems"/><Info k="Required expertise" v="Human-centered design, sensors, data analytics"/><Info k="Impact score" v="88/100"/></div></section>
