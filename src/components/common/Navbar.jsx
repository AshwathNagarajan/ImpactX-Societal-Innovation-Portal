  ...
  return <header className="sticky top-0 z-40 border-b bg-[#08111f]/85 backdrop-blur-xl">
    <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-3 px-4 sm:h-[68px]">
      ...
      <div className="flex items-center gap-2">
        <Link to="/login" className="hidden rounded-xl border border-blue/30 bg-blue/10 px-4 py-2 text-sm font-semibold text-blue shadow-sm hover:border-blue/60 sm:inline-flex">Login</Link>
